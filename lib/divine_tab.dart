...
class DivineTab extends StatefulWidget {
  const DivineTab({super.key});

  @override
  State<DivineTab> createState() => _DivineTabState();
}

class _DivineTabState extends State<DivineTab> {
  String _now = '';
